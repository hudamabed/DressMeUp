...
class WomenSearchScreen extends StatelessWidget {
  const WomenSearchScreen({super.key});
  static final DioMethods dioMethods = Get.put(DioMethods(), permanent: true);
  static Set<ProductData> displayList = Set.from(dioMethods.women);
                      ...
                      return InkWell(
                        onTap: () {
                          Get.to(() => DetailsAboutItem(
                              productData: displayList.elementAt(index)));
                        },
                        child: Container(
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                ...
                                CustomText(
                                  text: displayList.elementAt(index).title,
                                  height: 0.0,
                                  textOverflow: TextOverflow.ellipsis,
                                  fontsize: 16,
                                ...
                                Row(
                                  ...
                                  children: [
                                    CustomText(
                                      text:
                                          '\$${displayList.elementAt(index).price}',
                                      height: 0.0,
                                      textOverflow: TextOverflow.ellipsis,
                                      fontsize: 16,
                                      color: const Color(0xFF5C6AC4),
                                    ...
                                    Container(
                                      ...
                                      child: CustomPriceWithLine(
                                        text:
                                            '\$${displayList.elementAt(index).price + 56}',
                                        height: 0.0,
                                        textOverflow: TextOverflow.ellipsis,
                                        fontsize: 16,
