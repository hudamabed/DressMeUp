...
class KidProductScreen extends StatefulWidget {
  ...
  @override
  State<KidProductScreen> createState() => _KidProductScreenState();
}

class _KidProductScreenState extends State<KidProductScreen> {
  @override
                ...
                child: Padding(
                  ...
                  child: ListView.separated(
                    itemBuilder: (BuildContext context, int index) {
                      if (KidProductScreen.dioMethods.supkid.isEmpty) {
                        return const Center(
                          child: Center(child: CircularProgressIndicator()),
                        );
                      }
                      if (kDebugMode) {
                        print(KidProductScreen.dioMethods.supkid.length);
                      }
                      return InkWell(
                        onTap: () {
                          Get.to(() => DetailsAboutItem(productData : KidProductScreen.dioMethods.supkid
                                                .elementAt(index)));
                        },
                        child: Container(
                          width: double.infinity,
                            ...
                            children: [
                              Stack(
                                children: [
                                  Container(
                                    ...
                                    child: KidProductScreen.dioMethods.supkid
                                                .elementAt(index)
                                                .images
                                                .first ==
                                            null
                                        ...
                                        : Constant.instance.networkImage(
                                            imageUrl: KidProductScreen.dioMethods.supkid
                                                .elementAt(index)
                                                .images
                                                .first,
                                            fit: BoxFit.fill,
                                            ...
                                            return InkWell(
                                              onTap: () {
                                                ...
                                                if (snapshot.data ?? false) {
                                                  ...
                                                  setState(() {
                                                    controller
                                                      .deleteProduct(KidProductScreen
                                                  .dioMethods.supkid
                                                  .elementAt(index)
                                                  .id);
                                                  });
                                                    ...
                                                    WishListProduct(
                                                      ...
                                                      description:
                                                          KidProductScreen
                                                              ...
                                                              .elementAt(index)
                                                              .description,
                                                      image: KidProductScreen
                                                          .dioMethods.supkid
                                                          .elementAt(index)
                                                          .images
                                                          .first,
                                                      price: KidProductScreen
                                                          .dioMethods.supkid
                                                          .elementAt(index)
                                                          .price,
                                                      id: KidProductScreen
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      '${KidProductScreen.dioMethods.supkid.elementAt(index).category.name}',
                                    ...
                                    Text(
                                      '${KidProductScreen.dioMethods.supkid.elementAt(index).price}',
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      '${KidProductScreen.dioMethods.supkid.elementAt(index).title}',
                                      textAlign: TextAlign.left,
                                    ...
                                    Text(
                                      '${KidProductScreen.dioMethods.supkid.elementAt(index).price + 56}',
                                      textAlign: TextAlign.right,
                                      overflow: TextOverflow.ellipsis,
                                      style: GoogleFonts.nunito(
                                        fontWeight: FontWeight.w400,
                    ...
                    itemCount: KidProductScreen.dioMethods.supkid.length,
