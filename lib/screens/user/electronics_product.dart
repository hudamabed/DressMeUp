...
class ElectronicsProductScreen extends StatefulWidget {
  ...
  @override
  State<ElectronicsProductScreen> createState() => _ElectronicsProductScreenState();
}
                ...
                child: Padding(
                  ...
                  child: ListView.separated(
                    itemBuilder: (BuildContext context, int index) {
                      if (ElectronicsProductScreen.dioMethods.electronics.isEmpty) {
                        return const Center(
                          child: Center(child: CircularProgressIndicator()),
                        );
                      }
                      if (kDebugMode) {
                        print(ElectronicsProductScreen.dioMethods.electronics.length);
                      }
                      return InkWell(
                        onTap: () {
                          Get.to(() => DetailsAboutItem(productData : ElectronicsProductScreen.dioMethods.electronics
                                                .elementAt(index)));
                        },
                        child: Container(
                          width: double.infinity,
                            ...
                            children: [
                              Stack(
                                children: [
                                  Container(
                                    ...
                                    child: ElectronicsProductScreen.dioMethods.electronics
                                                .elementAt(index)
                                                .images
                                                .first ==
                                            null
                                        ...
                                        : Constant.instance.networkImage(
                                            imageUrl: ElectronicsProductScreen.dioMethods.electronics
                                                .elementAt(index)
                                                .images
                                                .first,
                                            fit: BoxFit.fill,
                                            ...
                                            return InkWell(
                                              onTap: () {
                                                ...
                                                if (snapshot.data ?? false) {
                                                  ...
                                                  setState(() {
                                                    controller
                                                      .deleteProduct(ElectronicsProductScreen
                                                  .dioMethods.electronics
                                                  .elementAt(index)
                                                  .id);
                                                  });
                                                  ...
                                                  setState(() {
                                                    ...
                                                    WishListProduct(
                                                      title: ElectronicsProductScreen
                                                          .dioMethods
                                                          .electronics
                                                          .elementAt(index)
                                                          .title,
                                                      description:
                                                          ElectronicsProductScreen
                                                              ...
                                                              .elementAt(index)
                                                              .description,
                                                      image: ElectronicsProductScreen
                                                          .dioMethods
                                                          .electronics
                                                          .elementAt(index)
                                                          .images
                                                          .first,
                                                      price: ElectronicsProductScreen
                                                          .dioMethods
                                                          .electronics
                                                          .elementAt(index)
                                                          .price,
                                                      id: ElectronicsProductScreen
                                                          .dioMethods
                                                          .electronics
                                                          .elementAt(index)
                                                          .id,
                                                ...
                                                return InkWell(
                                                      onTap: () {
                                                        ...
                                                        controller2.addProduct(
                                                          ...
                                                          .elementAt(index)
                                                                .title,
                                                            description: ElectronicsProductScreen
                                                          .dioMethods
                                                          .electronics
                                                          .elementAt(index)
                                                                .description,
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      '${ElectronicsProductScreen.dioMethods.electronics.elementAt(index).category.name}',
                                    ...
                                    Text(
                                      '${ElectronicsProductScreen.dioMethods.electronics.elementAt(index).price}',
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      '${ElectronicsProductScreen.dioMethods.electronics.elementAt(index).title}',
                                      textAlign: TextAlign.left,
                                    ...
                                    Text(
                                      '${ElectronicsProductScreen.dioMethods.electronics.elementAt(index).price + 56}',
                                      textAlign: TextAlign.right,
                                      overflow: TextOverflow.ellipsis,
                                      style: GoogleFonts.nunito(
                                        fontWeight: FontWeight.w400,
                    ...
                    itemCount: ElectronicsProductScreen.dioMethods.electronics.length,
